...
import DashboardLayout from '../../dashboard/DashbordLayout'; // Fixed typo: DashbordLayout → DashboardLayout
import { useParams } from 'react-router-dom';
import { fetchAccountByID, addCustomFields, deleteCustomFields, AddNote } from '../../../../Intreceptors/CustomerApi'; // Fixed typo: Intreceptors → Interceptors
import CustomFieldModal from './CustomeField'; // Fixed typo: CustomeField → CustomField
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        setAccount(res);
        setCustomFields(res?.custom_fields || {}); // Fixed typo: custome_fields → custom_fields
      ...
      <div className="bg-gray-50 min-h-screen">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                  ...
                  <div className="ml-5 w-0 flex-1">
                    <dl>
                      ...
                      <dd className="flex items-baseline">
                        <div className="text-2xl font-semibold text-gray-900">{stats.openDeals || 0}</div>
                      </dd>
                    </dl>
                  </div>
                </div>
                ...
                <div className="flex items-center">
                  ...
                  <div className="ml-5 w-0 flex-1">
                    <dl>
                      ...
                      <dd className="flex items-baseline">
                        <div className="text-2xl font-semibold text-gray-900">${stats?.totalValue?.toLocaleString() || '0'}</div>
                      </dd>
                    </dl>
                  </div>
                </div>
          ...
          <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
            ...
            {/* Right Column - Tabs for Deals, Tasks, Notes, Edit */}
